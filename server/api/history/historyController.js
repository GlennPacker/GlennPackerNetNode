exports.get = function (req, res, next) {
    res.send([{
        name: "Active Building Centre",
        jobTitle: "Senior Full Stack Developer",
        when: "Oct 2020 - Present",
        summary: "Green field software development of an 'internet of things' project",
        projectStyle: "Agile",
        technologies: [
            {
                text: "Mongo",
                ...
                text: "Passport (Local and JWT strategies)",
                isBackEnd: true,
            },{
                text: "Mongo, Mongoose, Passport (Local and JWT strategies)",
                isBackEnd: true,
            },
            {
                text: "React (React Hooks, Redux, React Router, React Material UI)",
                isBackEnd: false,
                link: "//react.glennpacker.net"
            }, {
                text: "Bootstrap, Bootstrap-Table-Next",
                isBackEnd: false,
            },
            {
                text: "JavaScript",
